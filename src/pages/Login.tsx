        ...
        <div className="card">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input id="password" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="input input-bordered w-full" placeholder="••••••••" />
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-base-content/70">Don't have an account? <Link to="/signup" className="text-primary hover:text-primary-focus font-medium">Sign up</Link></p>
          </div>
        </div>
      </div>
    </div>
